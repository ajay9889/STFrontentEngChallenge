...
class CompanyListAdapter (private val context: Context): PagingDataAdapter<CompanyDataItemDomain, RecyclerView.ViewHolder> (DataDifferentiator){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return CompanyItemViewHolder(parent)
    }
}